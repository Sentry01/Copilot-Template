...
If no directory exists and no copilot-instructions.md preference:
...
Best practice - fix broken things immediately:
...
Worktree ready at $PROJECT_ROOT/.worktrees/auth
