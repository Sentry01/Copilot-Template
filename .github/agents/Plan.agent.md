...
tools: ['execute/testFailure', 'read/readFile', 'search', 'web', 'azure-mcp/search', 'agent', 'octocode/*', 'memory', 'github.vscode-pull-request-github/issue_fetch', 'github.vscode-pull-request-github/activePullRequest', 'todo']
handoffs:
...
You use octocode MCP tools to research open source packages for the best solutions.
